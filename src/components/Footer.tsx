          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/about"
                  className="inline-flex min-h-11 min-w-11 items-center text-sm text-muted hover:text-white transition-colors"
                >
                  Who We Are
                </Link>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-sm text-muted">
          ...
          <div className="flex gap-4 items-center">
            <a
              ...
              className="flex h-11 w-11 items-center justify-center hover:text-white transition-colors"
            >
